...
namespace BizUnit.MQSeriesSteps
{
    ...
    ///             typeName="BizUnit.MQSeriesSteps.MQSeriesPutStep, BizUnit.MQSeriesSteps, Version=3.1.0.0, Culture=neutral, PublicKeyToken=7eb7d82981ae5162">
    ...
    public class MQSeriesPutStep : ITestStep
    {
        ...
        {
            var queueManager = testConfig.SelectSingleNode("QueueManager").InnerText;
            var queue = testConfig.SelectSingleNode("Queue").InnerText;
            var path = testConfig.SelectSingleNode("SourcePath").InnerText;
