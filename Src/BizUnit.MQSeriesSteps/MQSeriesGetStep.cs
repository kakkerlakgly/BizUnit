...
namespace BizUnit.MQSeriesSteps
{
    ...
    ///             typeName="BizUnit.MQSeriesSteps.MQSeriesGetStep, BizUnit.MQSeriesSteps, Version=3.1.0.0, Culture=neutral, PublicKeyToken=7eb7d82981ae5162">
    ...
    ///             <description>
    ///                 The time to wait for the message, after which if the message is not found the test step will
    ///                 fail, in seconds. Use -1 to wait forever.
    ///             </description>
    ///         </item>
    ///         <item>
    ...
    public class MQSeriesGetStep : ITestStep
    {
        ...
        {
            var queueManager = context.ReadConfigAsString(testConfig, "QueueManager");
            var queue = context.ReadConfigAsString(testConfig, "Queue");
            var waitTimeout = context.ReadConfigAsInt32(testConfig, "WaitTimeout");
