...
namespace BizUnit.TestDocumentor.Console
{
    internal class Program
    {
        private static void Main(string[] args)
        {
            ...
            documentor.GenerateDocumentation(args[0], args[1], args[2], args[3], args[4], null,
        ...
        private static void Usage(string[] args)
        {
            ...
            System.Console.WriteLine(
                "BizUnit.TestDocumentor.exe [Test Report Template] [Category Template] [Test Case Template] [BizUnit Test Directory] [Output File Name (.XML)] [Recursive]");
        }
    }
}