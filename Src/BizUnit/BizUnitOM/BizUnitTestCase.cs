...
namespace BizUnit.BizUnitOM
{
    ...
    public class BizUnitTestCase
    {
        ...
        /// </summary>
        /// <param name='testStep'>
        ///     The test step to add to the test case,
        ///     creation of the test step is delegated to the TestStepBuilder
        /// </param>
        ...
        ///     Specifies whether the test step
        ///     should run concurrently to other test steps. Defaults to false if not specified.
        /// </param>
        /// <param name='failOnError'>
        ///     Specifies whether the entire test case
        ///     should fail if this individual test step fails, defaults to true if not specified.
        /// </param>
        ...
        ///     should fail if this individual test step fails, defaults to true if not specified.
        /// </param>
        public void AddTestStep(ITestStep testStep, string config, TestStage stage, bool runConcurrently,
            bool failOnError)
        {
            ArgumentValidation.CheckForNullReference(testStep, "testStep");
            ArgumentValidation.CheckForNullReference(config, "config");
        ...
        ///     should fail if this individual test step fails, defaults to true if not specified.
        /// </param>
        public void AddTestStep(ITestStepOM testStep, TestStage stage, bool runConcurrently = false,
