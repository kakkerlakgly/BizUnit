...
namespace BizUnit.BizUnitOM
{
    ...
    public class TestStepBuilder : TestStepBuilderBase
    {
        ...
        /// </summary>
        /// <param name='testStep'>
        ///     A test step that has already been created and
        ///     that implements ITestStepOM.
        /// </param>
        ...
        /// </summary>
        /// <param name='typeName'>
        ///     The type name of the test step that will be
        ///     created by the TestStepBuilder, the step should implement ITestStepOM.
        /// </param>
        ...
        ///     The assembly path of the test step that will be
        ///     created by the TestStepBuilder, the step should implement ITestStepOM.
        /// </param>
        ...
        /// </summary>
        /// <value>
        ///     The Validation sub-step builder that will be executed during the
        ///     execution of the test step.
        /// </value>
        public ValidationStepBuilder ValidationStepBuilder { set; get; }

        /// <summary>
        ///     Set the ContextLoaderStepBuilder property.
        /// </summary>
        /// <value>
        ///     The Context Loader sub-step builder that will be executed during the
        ///     execution of the test step.
        /// </value>
        public ContextLoaderStepBuilder ContextLoaderStepBuilder { set; get; }

        private void SetProperty(Type t, object value)
        {
            var pi = GetProperty(t);
            if (null != pi)
            {
                var args = new[] {value};
