...
namespace BizUnit.TestSteps.BizTalk.Port
{
    ...
    ///             typeName="BizUnit.BizTalkSteps.ReceivePortConductorStep, BizUnit.BizTalkSteps, Version=3.1.0.0, Culture=neutral, PublicKeyToken=7eb7d82981ae5162">
    ...
    public class ReceivePortConductorStep : TestStepBase
    {
        ...
        {
            var wmiQuery =
                string.Format("Select * from MSBTS_ReceiveLocation where ReceivePortName=\"{0}\" and Name=\"{1}\"",
