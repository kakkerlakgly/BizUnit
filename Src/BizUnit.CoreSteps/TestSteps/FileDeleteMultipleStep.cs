...
namespace BizUnit.CoreSteps.TestSteps
{
    ...
    ///             <description>
    ///                 The FILE mask used to search for FILE's to delete, e.g. PO_{*}.xml will delete files such as
    ///                 PO_{87108BAF-6812-418D-A89D-3A2D68E98926}.xml
    ///             </description>
    ///         </item>
    ///     </list>
    /// </remarks>
    ...
    public class FileDeleteMultipleStep : ITestStepOM
    {
        ...
        public void Execute(Context context)
        {
            ...
            context.LogInfo("{0} files were found matching the File Mask: \"{1}\" in the directory: \"{2}\"",
                files.Length, _searchPattern, _directory);
