...
{
    /// <summary>
    ///     The EventLogClearStep test step clears the event log(s) on specified machines. Note: caution should be taken when
    ///     clearing event log.
    /// </summary>
    /// <remarks>
    ...
    ///             <term>Machine</term>
    ///             <description>
    ///                 The name(s) of the machine(s) where the event log should be cleared, a comma delimeted list
    ///                 may be specified
    ///                 <para>(optional, defaults to local machine)</para>
    ///             </description>
    ///         </item>
    ///         <item>
    ///             <term>EventLog</term>
