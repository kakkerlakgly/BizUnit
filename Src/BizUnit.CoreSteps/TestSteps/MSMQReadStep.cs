...
namespace BizUnit.CoreSteps.TestSteps
{
    ...
    ///             <description>
    ///                 The validation step that will be used to validate the contents of the message read from the
    ///                 queue (optional).
    ///             </description>
    ///         </item>
    ///         <item>
    ...
    ///             <description>
    ///                 Allows properties from the MSMQ message to be written to the BizUnit context.
    ...
    ///                 <para>(Optional)(One or more)</para>
    ///             </description>
    ///         </item>
    ///     </list>
    /// </remarks>
    ...
    public class MSMQReadStep : ITestStep
    {
        ...
        public void Execute(XmlNode testConfig, Context context)
        {
            ...
            var ctxProps = testConfig.SelectNodes("ContextProperties/*");
        ...
        private static void ProcessContextProperties(Context context, XmlNodeList props, Message msg)
        {
            ...
            {
                // <ContextProperty MSMQProp="CorrelationId" CtxPropName="MSMQ_CorrelationId" />
                var ctxPropName = prop.SelectSingleNode("@CtxPropName").Value;
                var msmqPropName = prop.SelectSingleNode("@MSMQProp").Value;
