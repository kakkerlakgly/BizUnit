...
namespace BizUnit.CoreSteps.TestSteps
{
    ...
    internal class FileReadAndLoadToContext : ITestStep
    {
        /// <summary>
        ...
        {
            var filePath = context.ReadConfigAsString(testConfig, "FilePath");
            var contextPropertyName = context.ReadConfigAsString(testConfig, "ContextPropertyName");
            var timeOut = context.ReadConfigAsDouble(testConfig, "TimeOut", true);

            context.LogInfo("About to load the context property: {0} with the contents of the file: (1)",
                contextPropertyName, filePath);
