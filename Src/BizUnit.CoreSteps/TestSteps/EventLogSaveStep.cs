...
namespace BizUnit.CoreSteps.TestSteps
{
    ...
    ///             <term>Server</term>
    ///             <description>
    ///                 The name of the machine(s) where the event log should be saved from, multiple servers are
    ///                 specified through the use of a comma delimiter
    ///             </description>
    ///         </item>
    ///         <item>
    ///             <term>DestinationPath</term>
    ///             <description>
    ///                 The local path to save the event log to, minus the file name or trailing backslash, the
    ///                 resulting filename will be SERVERNAME.evt
    ///             </description>
    ///         </item>
    ///     </list>
    /// </remarks>
