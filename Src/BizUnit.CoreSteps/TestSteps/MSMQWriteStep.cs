...
namespace BizUnit.CoreSteps.TestSteps
{
    ...
    ///             <description>
    ///                 Defaults to true, when using transactions the message will be written to the queue using
    ///                 MessageQueueTransactionType.Single, if set to false MessageQueueTransactionType.None will be used
    ///                 (optional)
    ///             </description>
    ///         </item>
    ///     </list>
    ...
    public class MSMQWriteStep : ITestStep
    {
        ...
        public void Execute(XmlNode testConfig, Context context)
        {
            ...
            var queuePath = context.ReadConfigAsString(testConfig, "QueuePath");
            var messageLabel = context.ReadConfigAsString(testConfig, "MessageLabel");
            var correlationId = context.ReadConfigAsString(testConfig, "CorrelationId", true);
            var appSpecific = context.ReadConfigAsInt32(testConfig, "AppSpecific", true);
            var objUseTransactions = context.ReadConfigAsObject(testConfig, "UseTransactions", true);
