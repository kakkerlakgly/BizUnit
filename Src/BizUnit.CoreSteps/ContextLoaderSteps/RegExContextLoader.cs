...
namespace BizUnit.CoreSteps.ContextLoaderSteps
{
    ...
    ///         <item>
    ///             <term>RegEx</term>
    ///             <description>The regular expression to be executed against the input data
    ///                 <para>(repeating)</para>
    ///             </description>
    ///         </item>
    ///         <item>
    ...
    public class RegExContextLoader : IContextLoaderStep
    {
        ...
        {
            var xpressions = contextConfig.SelectNodes("RegEx");
            ...
            {
                var key = xpression.SelectSingleNode("@contextKey");
                var match = Regex.Match(input, xpression.InnerText);
